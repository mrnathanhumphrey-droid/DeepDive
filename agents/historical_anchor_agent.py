...
class HistoricalAnchorAgent(BaseAgent):
    """Gate agent: verifies the historical anchor event before any
    downstream historical analysis proceeds."""

    agent_type = AgentType.HISTORICAL_ANCHOR
    system_prompt = load("agents/historical_anchor_system_prompt")
    ...
    def _get_analysis_instruction(self, mode: str = "general") -> str:
        return load("agents/historical_anchor_analysis_instruction")
