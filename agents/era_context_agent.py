...
class EraContextAgent(BaseAgent):
    """Reconstructs the political, economic, and social environment
    at the time of the historical anchor event."""

    agent_type = AgentType.ERA_CONTEXT
    system_prompt = load("agents/era_context_system_prompt")
    ...
    def _get_analysis_instruction(self, mode: str = "general") -> str:
        return load("agents/era_context_analysis_instruction")
