...
class ScholarlyConsensusAgent(BaseAgent):
    """Maps the historiographic landscape — where scholars agree,
    disagree, and how interpretation has evolved."""

    agent_type = AgentType.SCHOLARLY_CONSENSUS
    system_prompt = load("agents/scholarly_consensus_system_prompt")
    ...
    def _get_analysis_instruction(self, mode: str = "general") -> str:
        return load("agents/scholarly_consensus_analysis_instruction")
