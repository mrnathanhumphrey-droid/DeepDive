...
class PrimarySourceAgent(BaseAgent):
    """Identifies and summarizes key primary source documents
    related to the historical anchor event."""

    agent_type = AgentType.PRIMARY_SOURCE
    system_prompt = load("agents/primary_source_system_prompt")
    ...
    def _get_analysis_instruction(self, mode: str = "general") -> str:
        return load("agents/primary_source_analysis_instruction")
