...
class TimelineAgent(BaseAgent):
    ...
    system_prompt = load("agents/timeline_system_prompt")

    def _call_claude(self, prompt: str, topic: str = "", sub_topic: str = "") -> str:
        """Override to use web search for verifying dates, P.L. numbers, and vote tallies."""
    ...
    def _get_analysis_instruction(self, mode: str = "general") -> str:
        return load("agents/timeline_analysis_instruction")
